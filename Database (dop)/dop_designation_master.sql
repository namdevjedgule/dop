...
CREATE TABLE `designation_master` (
  ...
  UNIQUE KEY `UKtohsmoj9esfq82blxg12hxjbd` (`designation_name`)
...
INSERT INTO `designation_master` VALUES (5,'Analyst'),(4,'Consultant'),(1,'Director/VP'),(3,'Manager'),(7,'Other'),(2,'Project Manager'),(6,'Student');
