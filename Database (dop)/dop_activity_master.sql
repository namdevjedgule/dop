...
LOCK TABLES `activity_master` WRITE;
/*!40000 ALTER TABLE `activity_master` DISABLE KEYS */;
INSERT INTO `activity_master` VALUES (1,'File Management'),(2,'Analytics');
/*!40000 ALTER TABLE `activity_master` ENABLE KEYS */;
UNLOCK TABLES;
